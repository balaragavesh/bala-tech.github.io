...
export default function Footer() {
  return (
    <div className="font-Poppins text-center bg-zinc-900 text-gray-100 py-40">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-4">
        ...
        <div className="md:text-left text-left flex flex-col items-start max-w-xs py-10 md:py-5">
          <div className="flex items-top mb-2">
            <img src="https://icon-library.com/images/address-icon-white/address-icon-white-28.jpg" alt="Address" className="w-8 h-8 mr-2" />
            <p>Address : 38b, Parthasarathy St, S S Colony, Madurai, Tamil Nadu 625016.</p>
          </div>
          <div className="flex items-top mb-2">
